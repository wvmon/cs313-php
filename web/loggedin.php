    ...
    <body>
        ...
        <div class="container">
            <div class="row logged">
                <div class="col-lg-4"><a href="new_entry.php" class="sub"><i class="fa fa-file fa-5x" aria-hidden="true"></i></a></div>
                <div class="col-lg-4"><a href="history.php" class="sub"><i class="fa fa-history fa-5x" aria-hidden="true"></i></a></div>
                <div class="col-lg-4"><a href="logout.php" class="sub"><i class="fa fa-sign-out fa-5x" aria-hidden="true"></i></a></div>
            </div>
        </div>
    </body>
</html>